                ...
                <div className="login-aside-left" style={{backgroundImage:"url("+ login +")"}}>
                    ...
                    <div className="login-description">
                        <div className="mt-5">
                            ...
                            <Link to={"#"} className="text-black">Rights Reserved © 2021 WriteEdit</Link>
                        </div>
                    </div>
                </div>
                          ...
                          <div className="row no-gutters">
                            <div className="col-xl-12">
                              <div className="auth-form-1">
                                <div className="mb-4">
                                    <h3 className="text-primary mb-1">Powered by Zype Online</h3>
                                    <p className="">Sign into the WriteEdit Dashboard</p>
                                </div>
                                {props.errorMessage && (
