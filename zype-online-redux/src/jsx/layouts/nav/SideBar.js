        ...
        <PerfectScrollbar className="deznav-scroll">
          <MM className="metismenu" id="menu">
            <li className={`${dashBoard.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#" >
				...
				<ul >
					<li>
						<Link className={`${path === "dashboard" ? "mm-active" : ""}`} to="/dashboard" onClick={() => this.props.onClick3()}>Dashboard</Link>
					</li>
					<li>
						<Link className={`${path === "event-list" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/event-list">Event List</Link>
					</li>
					<li>
						<Link className={`${path === "event" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/event">Event</Link>
					</li>					
					<li>
						<Link className={`${path === "customers" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/customers">Customer</Link>
						
					</li>
					<li>	
						<Link className={`${path === "analytics" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/analytics">Analytics</Link>
					</li>
					<li>
						<Link className={`${path === "reviews" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/reviews">Review</Link>
					</li>
                    <li>
		  ...
		  <div className="plus-box">
			...
			<div className="copyright">
				<p className="fs-14 font-w200"><strong className="font-w400">Karciz Ticketing Admin Dashboard</strong> © 2021 All Rights Reserved</p>
